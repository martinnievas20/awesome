...
-- {{{ Tags
tags = {
  names   = { "terminal", "internet", "files", "graph", "music", "six", "settimanna", "otto", "nine", "10" },
...
--  right_wibox:add(space)
 ...
 -- left_graphbox:add(tab)
  ...
  --left_graphbox:add(rxwidget)
  left_graphbox:add(pomodoro.widget, pomodoro.icon_widget ,mytextclock)
